...
- **Reports** — Job report, lead performance, team performance, lost jobs, overview, workflow, and pipeline. Date range and CSV export. Company admin and accounting see the whole company; business development sees every job; team leads see their crew only. Project managers and field seats do not get this page.
