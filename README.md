...
- **Estimates** — write a proposal from the price book (sections, optional work, tax), download a PDF, send a client link. Signing writes the signed total onto the job card and moves the work to In progress. Convert included lines to an invoice.
