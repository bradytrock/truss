  ...
  return (
    <div className="space-y-5">
      ...
      <PageHeader
        eyebrow="Settings"
        title="Price book"
        description="Company catalog of labor, material, equipment, allowances, and subcontract packages. Upload a CSV to load the book at once, or add items one at a time."
        actions={
