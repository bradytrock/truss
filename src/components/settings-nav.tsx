...
export function SettingsNav() {
  ...
  return (
    <nav
      ...
      className="sticky top-12 z-20 -mx-5 border-b bg-background px-5 py-2 sm:-mx-7 sm:px-7 lg:top-16 lg:mx-0 lg:w-52 lg:shrink-0 lg:border-b-0 lg:px-0 lg:py-0"
    >
