...
const SECTIONS = [
  ...
  { href: "/settings/documents", label: "Documents", hint: "Contracts and margin", admin: true, accounting: false, automations: false },
  ...
  { href: "/settings/texts", label: "Texts", hint: "myCRMSIM workspace", admin: true, accounting: false, automations: false },
